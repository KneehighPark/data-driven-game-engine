...
namespace Library
{
	...
	{
		return {{ SubtypeKey, Datum::DatumType::STRING, 1, offsetof(EventMessageAttributed, mSubtype) }};
	}
	...
	EventMessageAttributed::EventMessageAttributed(World& world) : EventMessageAttributed(world, std::string())
	{

	}

	EventMessageAttributed::EventMessageAttributed(World& world, const std::string& subtype) : 	Attributed(TypeIdClass()), mWorld(&world), mSubtype(subtype)
	{
